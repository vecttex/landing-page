...
export const esES: Resources = {
  meta: {
    title: "Vecttex — Sitios web y aplicaciones profesionales para empresas",
    description:
      "Sitios web y aplicaciones para empresas que quieren ser tomadas en serio en internet. Atención directa por WhatsApp en todo Brasil.",
    ogTitle: "Vecttex — Conexión. Innovación. Tecnología.",
    ogDescription:
      "Sitios web y aplicaciones para empresas que quieren ser tomadas en serio en internet. Atención directa por WhatsApp.",
    ogLocale: "es_ES",
  },
  brand: {
    descriptor: "Tecnología y Desarrollo",
    claim:
  ...
  common: {
    ...
    sendProject: "Enviar mi proyecto",
    seeMore: "Ver más",
  ...
  contact: {
    address: "Gravataí - Rio Grande do Sul, Brasil",
    coverage: "Atención en línea en todo Brasil",
  ...
  home: {
    ...
    stats: [
      { value: "6", label: "Formatos de proyecto" },
      { value: "100%", label: "Adaptados al móvil" },
      { value: "1:1", label: "Atención por WhatsApp" },
      { value: "5", label: "Etapas del briefing a la entrega" },
    ],
    pillars: [
      { id: "fit", label: "Un proyecto alineado con tu negocio" },
      { id: "whatsapp", label: "WhatsApp directo con quienes lo desarrollan" },
      { id: "craft", label: "Acabado y rendimiento" },
    ],
    about: {
    ...
    services: {
      eyebrow: "Servicios",
      title: "Lo que entregamos<br/> en cada proyecto.",
      lead: "Desde el primer borrador hasta la entrega, nos ocupamos de todo lo que hace que un sitio web se vea profesional y funcione como tal.",
      link: "Ver todos los servicios",
    },
    types: {
      eyebrow: "Tipos de proyecto",
      title: "Elige el formato<brSm/> adecuado para tu objetivo.",
      lead: "Cada negocio comunica de una manera diferente. Desarrollamos distintos formatos y también proyectos que rompen por completo con lo habitual.",
      link: "Ver todos los formatos",
    },
    process: {
      eyebrow: "Cómo funciona",
      title: "Un proceso<br/> <accent>sin sorpresas.</accent>",
      lead: "Desde el primer “buen día” por WhatsApp hasta la entrega, sabes exactamente en qué etapa está tu proyecto.",
  ...
  about: {
    ...
    manifesto: {
      ...
      title: "Un sitio web no es solo una página.<br/><accent>Es la primera impresión.</accent>",
      paragraphs: [
        "Muchos negocios excelentes todavía son juzgados por una presencia digital que no corresponde a la calidad de lo que entregan. Nuestro trabajo es corregir ese desajuste.",
  ...
  services: {
    hero: {
      eyebrow: "Servicios",
      title: "Todo lo que tu empresa necesita para <accent>existir bien en internet.</accent>",
      lead: "Sitios web y aplicaciones alineados con tu negocio, y el método que usamos para llegar allí desde el primer contacto hasta la entrega.",
    },
    deliverables: {
    ...
    prepare: {
      ...
      title: "Lo que ayuda a<br/> <accent>acelerar el proyecto.</accent>",
      lead: "Nada de esto es obligatorio para iniciar la conversación, pero cuanta más información tengamos, más rápido llegaremos al resultado ideal.",
      cta: "Comenzar mi proyecto",
      items: [
        { id: "business", title: "Información del negocio", desc: "Nombre, a qué te dedicas, diferenciales, horarios y formas de contacto." },
        { id: "media", title: "Imágenes y logotipo", desc: "Fotos del espacio, los productos o el equipo. Si no las tienes, te orientaremos." },
        { id: "goal", title: "Objetivo del sitio web", desc: "Recibir contactos, mostrar el catálogo o divulgar un servicio específico." },
        { id: "references", title: "Referencias que te gustan", desc: "Los sitios web que te gustan nos ayudan a definir más rápido la dirección visual." },
      ],
    },
    extras: {
      eyebrow: "Servicios adicionales",
      title: "Más allá del sitio web, si<brSm/> necesitas algo más.",
      lead: "Servicios opcionales que puedes añadir al proyecto, con el alcance acordado antes de empezar.",
      items: [
        { id: "hosting", title: "Alojamiento del sitio web", desc: "Nos ocupamos del alojamiento para que no tengas que preocuparte por la parte técnica: tu sitio en línea, estable y monitorizado.", highlight: "Servicio opcional: las condiciones se acuerdan directamente contigo, sin permanencia.", points: ["Sitio web en línea y estable", "Nos ocupamos de la parte técnica", "Cancela libremente en cualquier momento"] },
        { id: "app", title: "Aplicación móvil", desc: "Además del sitio web, también desarrollamos aplicaciones móviles. Definimos contigo qué hará la aplicación.", highlight: "Las funcionalidades se definen con el cliente: no prometemos nada antes de analizar el proyecto.", points: ["Alcance definido en conversación", "Proyecto evaluado caso por caso", "Desarrollo después de la alineación"] },
      ],
    },
    faq: {
      eyebrow: "Preguntas frecuentes",
      title: "Todo claro,<br/> desde el principio.",
      lead: "Si alguna pregunta no está respondida aquí, escríbenos por WhatsApp usando el botón en la esquina de la pantalla.",
      items: [
        { id: "scope", q: "¿Solo desarrollan sitios de presentación?", a: "No. Los sitios de presentación son una parte de lo que hacemos. También desarrollamos sitios institucionales, landing pages, portafolios, catálogos en línea y proyectos personalizados según la necesidad." },
        { id: "support", q: "¿Cómo funciona el soporte?", a: "El soporte se realiza por WhatsApp, de forma directa y personal. Hablas con nuestro equipo para resolver dudas y seguir el proyecto durante el desarrollo y después de la entrega." },
        { id: "materials", q: "¿Necesito tener el logotipo y las fotos listos para empezar?", a: "No es obligatorio. Cuanto más material tengas, más rápido avanzará el proyecto, pero si todavía no lo tienes, te orientaremos sobre qué producir y avanzaremos con lo disponible." },
        { id: "apps", q: "¿Desarrollan aplicaciones?", a: "Sí, la aplicación móvil es un servicio adicional. Las funcionalidades se definen junto con el cliente después de entender las necesidades del proyecto." },
        { id: "quote", q: "¿Cómo solicito un presupuesto?", a: "Escríbenos por WhatsApp o completa el formulario de la página de contacto. Cuando entendamos el alcance de tu proyecto, te enviaremos todas las condiciones directamente." },
      ],
    },
  },
  contactPage: {
    hero: {
      eyebrow: "Contacto",
      title: "Hablemos sobre <accent>tu proyecto.</accent>",
      lead: "Cuéntanos un poco sobre tu negocio y lo que necesitas. Nuestro equipo responde por WhatsApp con atención cercana y directa.",
    },
    form: {
      eyebrow: "Formulario rápido",
      title: "Envía los detalles",
      lead: "Completa los campos y el resumen de tu proyecto se enviará directamente a nuestro WhatsApp.",
      nameLabel: "Tu nombre *",
    ...
    waMessage: {
      ...
      fallback: "Me gustaría hablar sobre un proyecto.",
    },
    channel: {
      eyebrow: "Canal principal",
      title: "WhatsApp",
      desc: "La forma más rápida de contactar con nuestro equipo. Respondemos preguntas, enviamos presupuestos y seguimos el proyecto por aquí.",
    },
  },
  notFound: {
    code: "Error 404",
    title: "Página no <accent>encontrada</accent>",
    lead: "La dirección que intentaste abrir no existe. Vuelve al inicio o habla con nuestro equipo usando el botón de WhatsApp en la esquina de la pantalla.",
